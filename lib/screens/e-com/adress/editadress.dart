...
class EditAdressDetails extends StatefulWidget {
  const EditAdressDetails({
    super.key,
  });

  @override
  State<EditAdressDetails> createState() => _EditAdressDetailsState();
}

class _EditAdressDetailsState extends State<EditAdressDetails> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const AppbarSection(heading: "Edit Location"),
              SizedBox(
                height: height * .03,
              ),
